...
import com.android.example.viewbindingsample.databinding.LayoutMergeBinding
...
class InflateFragment : Fragment() {
    ...
    private var mergeBinding: LayoutMergeBinding? = null
    ...
    override fun onCreateView(
        ...
        mergeBinding?.tvMerge?.text = "change merge"
        return binding.root
    }
